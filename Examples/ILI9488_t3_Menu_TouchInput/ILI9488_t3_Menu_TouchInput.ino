/*
  ...
  example in how to implement the ili9488_t3_menu library. This is an example that
...
#include "ILI9488_t3.h"                // high speed display that ships with Teensy
#include "ILI9488_t3_font_Arial.h"      // custom fonts that ships with ILI9341_t3.h
#include "ILI9488_t3_font_ArialBold.h"      // custom fonts that ships with ILI9341_t3.h
...
#define FONT_EDITTITLE  Arial_24_Bold            // font for menus
#define FONT_ITEM       Arial_24             // font for menus
#define FONT_TITLE      Arial_32_Bold        // font for all headings
...
const char *RefreshItems[] =   {"Off", "1 sec", "2 sec", "10 sec",
                                "30 sec", "1 min", "5 min"
                               };
const char *PrecisionItems[] =   {"10", "0", "0.0", "0.00", "0.000"
                                 };
const char *TuneItems[] =   {"Offset", "Simple", "Linear", "2nd order ", "3rd order", "Log"
                            };
...
const char *C_NAMES[] = {"White", "Black", "Grey", "Blue", "Red", "Green", "Cyan", "Magenta",
                         ...
                         "Md Grey", "Md Blue", "Md Red", "Md Green", "Md Cyan", "Md Magenta", "Md Yellow", "Md Teal",
                         "Md Orange", "Md Pink", "Md Purple", "Dk Grey", "Dk Blue", "Dk Red", "Dk Green", "Dk Cyan",
...
uint16_t MENU_SELECTBORDER = C_VALUES[13]; //37
...
// you know the drill
ILI9488_t3 Display(CS_PIN, DC_PIN, RST_PIN); //Display object
...
EditMenu ColorMenu(&Display, true);
EditMenu WirelessMenu(&Display, true);
...
void setup() {
  ...
  */
  ...
  MainMenu.init(MENU_TEXT, MENU_BACKGROUND, MENU_HIGHLIGHTTEXT, MENU_HIGHLIGHT,
                85, 3, "Main Menu", FONT_TITLE, FONT_TITLE);
  ...
  */
  ...
  MainMenu.setTitleBarSize(0, 0, 480, 70);
  ...
  MainMenu.setTitleTextMargins(60, 17);
  ...
  MainMenu.setMenuBarMargins(0, 470, 5, 2);
  ...
  MainMenu.setItemTextMargins(10, 18, 5);
  ...
  */
  OptionMenu.init(MENU_TEXT, MENU_BACKGROUND, MENU_HIGHLIGHTTEXT, MENU_HIGHLIGHT, MENU_SELECTTEXT, MENU_SELECT,
                  300, 40, 6, "Options Menu", FONT_ITEM, FONT_TITLE);
  ...
  */
  ...
  OptionOption2 = OptionMenu.add565("Temp2 Adj.", Temp2Adj, -1.0, 1.0 , .05, 2, NULL, epd_bitmap_Temp2, 32, 32);
  ...
  OptionOption4 = OptionMenu.add565("Tune", 0, 0, sizeof(TuneItems) / sizeof(TuneItems[0]) , 1, 0, TuneItems, epd_bitmap_Tune, 32, 32);
  ...
  ColorMenu.init(MENU_TEXT, MENU_BACKGROUND, MENU_HIGHLIGHTTEXT, MENU_HIGHLIGHT, MENU_SELECTTEXT, MENU_SELECT,
                 250, 40, 6, "Color Menu", FONT_ITEM, FONT_TITLE);
  ...
  ColorOption8 = ColorMenu.addNI("Edit Border", 13, 0, sizeof(C_NAMES) / sizeof(C_NAMES[0]), 1, 0, C_NAMES);
  ...
  ColorMenu.setTitleBarSize(0, 0, 480, 60);
  ColorMenu.setTitleTextMargins(70, 7);
  ColorMenu.setMenuBarMargins(10, 470, 4, 2);
  ColorMenu.setIconMargins(10, 0);
  ColorMenu.setItemTextMargins(7, 3, 10);
  ColorMenu.setItemColors(MENU_DISABLE, MENU_HIGHBORDER, MENU_SELECTBORDER);
  ColorMenu.setTitleColors(TITLE_TEXT, TITLE_BACK);
  ColorMenu.setIncrementDelay(50);
  ...
  WirelessMenu.init(MENU_TEXT, MENU_BACKGROUND, MENU_HIGHLIGHTTEXT, MENU_HIGHLIGHT, MENU_SELECTTEXT, MENU_SELECT,
                    300, 40, 6, "Wireless Menu", FONT_ITEM, FONT_TITLE);
  ...
  WirelessMenu.setTitleBarSize(0, 0, 480, 60);
  WirelessMenu.setTitleTextMargins(70, 7);
  WirelessMenu.setMenuBarMargins(10, 470, 4, 2);
  WirelessMenu.setIconMargins(10, 0);
  WirelessMenu.setItemTextMargins(7, 3, 10);
  ...
  WirelessMenu.setIncrementDelay(50);
...
void loop() {
  ...
  Display.setTextColor(ILI9488_RED, ILI9488_WHITE);
  Display.print(F("Done"));
  delay(500);
  Display.setCursor(10, 100);
  Display.setFont(FONT_TITLE);
  Display.setTextColor(ILI9488_BLUE, ILI9488_BLUE);
  Display.print(F("Done"));
  delay(500);
...
int ProcessMainMenu() {
  ...
  while (MainMenuOption != 0) {
    ...
    if (Touch.touched()) {
      ...
      // automatically handle press/unpress stays pressed while
      // you are pressing and without flicker
...
void ProcessWirelessMenu() {
  ...
  while (WirelessMenuOption != 0) {
    if (Touch.touched()) {
      ProcessTouch(); // gotta transform screen location to actuall x-y
      ...
      // for EditMenu drawRow ONLY needs to know what row you want to draw
      // the library will handle how to draw it
      // it will automatically put you in edit mode, then press on a row being editied
      // will accept that entry and escape editing--you do nothing lib does it all
...
void ProcessOptionMenu() {
  ...
  while (EditMenuOption != 0) {
    ...
    if (Touch.touched()) {
      ...
      // this next section is purely optional and shows how data change can be used
      // to modify other values
      if (EditMenuOption == OptionOption5) { // just and example of how to change another row and enable/disable

        if (OptionMenu.value[OptionOption5] == 0) {
          OptionMenu.disable(OptionOption4);
          OptionMenu.setItemText(OptionOption4, "Tune (Alarm)");
  ...
  Serial.print("Temp1 Adj "); Serial.println(OptionMenu.value[OptionOption1]);
...
void ProcessTouch() {
  ...
  /*
    ...
    Serial.print(",");
    Serial.print(BtnY);
    Display.drawPixel(BtnX, BtnY, ILI9488_GREEN);
  */
  ...
  /*
      ...
      Serial.print(",");
      Serial.println(BtnY);
      Display.fillCircle(BtnX, BtnY, 3, ILI9488_RED);
  */
...
/*
  ...
  void setItemColors( uint16_t DisableTextColor, uint16_t BorderColor, uint);
